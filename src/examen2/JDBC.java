...
public class JDBC {
    public static void main(String[] args) {
        ...
        try {
            ...
            String sql = "select codOe,codCurso,h.codTramo,h.codAsig, nombre,horasSemanales from horario h join asignatura a on h.codAsig=a.codAsig join tramohorario t on h.codTramo = t.codTramo group by 1,2,4,3,5,6 order by 1,2,4,dia asc,3 asc";
